markdown-pp ./sapphiredb-js.README.mdpp -o ../sapphiredb-js/README.md
markdown-pp ./sapphiredb.README.mdpp -o ../sapphiredb-js/projects/sapphiredb/README.md
markdown-pp ./ng-sapphiredb.README.mdpp -o ../sapphiredb-js/projects/ng-sapphiredb/README.md
